              ...
              <div class="col-lg-12">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-2"><i class="fas fa-key"></i> <b>Confirm Password</b></h1>
                 ...
                 @enderror
                    ...
                    <button type="submit" class="btn btn-danger btn-user btn-block">Confirm Password</button>
                  </form>
                  <hr>
                  @auth
                  <div class="text-center">
                  <a class="small" href="{{ route('logout') }}" onclick="event.preventDefault();document.getElementById('logout-form').submit();"><b>Log Out</b></a>
