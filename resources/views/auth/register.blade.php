          ...
          <div class="col-lg-12">
            ...
            <form class="user" method="POST" action="{{ route('register') }}">
              @csrf
                ...
                <div class="form-group">
                  <select name="user_type" class="form-control form-control-user1 @error('user_type') is-invalid @enderror" value="{{ old('user_type') }}" required autocomplete="user_type">
                      <option value="">Please Select the account type</option>
