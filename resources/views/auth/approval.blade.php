                ...
                <div class="p-5">
                 ...
                 <hr>
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-2"><i class="fas fa-clipboard-list"></i> <b>Waiting For Approval</b></h1>
                    <p class="mb-4">Before proceeding, we have to approve your account first. It is currently being reviewed by our specialists check back later to see the approval status.</p>
                  </div>
                  <hr>
                  @auth
                  <div class="text-center">
