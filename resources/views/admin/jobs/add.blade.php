        ...
        <div class="col-lg-12">
          <div class="p-5">
            ...
            <div class="form-group row">
            	<div class="col-12">
            		<label for="compemail" class="mx-1" style="color:#161616;"><b>Posting Job on behalf of : </b><span style="color:red"> *</span></label>
            		<select class="form-control" name="compemail" id="compemail" required>
                          <option value='' >Select</options>
                            @foreach ($comps as $items)
                                <option value='{{$items->email}}' @if($items->email==old('compemail')){{'selected'}}@endif>{{$items->name}} | {{$items->email}}</options>
                              @endforeach
                        </select>
                          @error('compemail')
