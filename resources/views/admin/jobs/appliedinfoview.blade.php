...
@endif
                           ...
                           @foreach($stud_qual as $it)
                              ...
                              <div class="form-group">
                                <p><b class="black">Logo</b> : <img class="rounded-circle border-grey" width="120" height="120" src="{{ url('storage/uploads/company/photo/'.$comp_det->Photo) }}" id="photoview"></p>
                                <p><b class="black">Company Name</b> : {{ $comp_n->name }}</p>
                                <p><b class="black">Company Website</b> : {{ $comp_det->URL }}</p>
                                <p><b class="black">Company Address</b> : {{ $comp_det->Address }}</p>
                                <p><b class="black">Company Phone No</b> : {{ $comp_det->Phoneno }}</p>
                              </div>
